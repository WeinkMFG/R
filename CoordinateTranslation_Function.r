#Translating coordinates from one system to another
...
#2.0	Complete rework, including the following:
#		-Input data do not have to be all of the same format
#		-Input format is coded per data entry
#		-Coding the hemisphere as "N", "S", "E", and "W" is now supported
#		-Several tests for data consistency has been added
#		-Collapsing of DMS and DMM data to print format is now possible
#		-Options to choose whether or not to Import/Export data has been removed
#		-Meta data for each coordinate can now be provided to facilitate comparability
#2.1	An error was fixed, that would lead to wrong results during a DMM-->DD conversion,
#		when the minutes-part was smaller than 6
#2.1.1	Changed a few fragments in the code to make it less bulky.
#--------------------------------------------
#--------------------------------------------
